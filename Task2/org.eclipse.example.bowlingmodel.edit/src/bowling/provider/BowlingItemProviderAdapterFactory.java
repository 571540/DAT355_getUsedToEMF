...
public class BowlingItemProviderAdapterFactory extends BowlingAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link bowling.Leauge} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected LeaugeItemProvider leaugeItemProvider;

	/**
	 * This creates an adapter for a {@link bowling.Leauge}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createLeaugeAdapter() {
		if (leaugeItemProvider == null) {
			leaugeItemProvider = new LeaugeItemProvider(this);
		}

		return leaugeItemProvider;
	}
	...
	public void dispose() {
		...
		if (leaugeItemProvider != null) leaugeItemProvider.dispose();
