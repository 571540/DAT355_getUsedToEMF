...
public class BowlingPackageImpl extends EPackageImpl implements BowlingPackage {
	 ...
	 * @generated
	 */
	private EClass leaugeEClass = null;
	 ...
	 * @generated
	 */
	public EAttribute getLeauge_Name() {
		return (EAttribute)leaugeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getLeauge_Players() {
		return (EReference)leaugeEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		leaugeEClass = createEClass(LEAUGE);
		createEAttribute(leaugeEClass, LEAUGE__NAME);
		createEReference(leaugeEClass, LEAUGE__PLAYERS);
	...
	public void initializePackageContents() {
		...
		initEClass(leaugeEClass, Leauge.class, "Leauge", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLeauge_Name(), ecorePackage.getEString(), "name", null, 0, 1, Leauge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLeauge_Players(), this.getPlayer(), null, "players", null, 0, -1, Leauge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
