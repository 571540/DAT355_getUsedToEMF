...
public class BowlingAdapterFactory extends AdapterFactoryImpl {
	...
	protected BowlingSwitch<Adapter> modelSwitch =
		new BowlingSwitch<Adapter>() {
			...
			@Override
			public Adapter caseLeauge(Leauge object) {
				return createLeaugeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link bowling.Leauge <em>Leauge</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLeaugeAdapter() {
		return null;
	}
