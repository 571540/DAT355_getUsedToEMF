...
public interface BowlingPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link bowling.impl.LeaugeImpl <em>Leauge</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see bowling.impl.LeaugeImpl
	 * @see bowling.impl.BowlingPackageImpl#getLeauge()
	 * @generated
	 */
	int LEAUGE = 1;
	 ...
	 * @ordered
	 */
	int LEAUGE__PLAYERS = 1;

	/**
	 * The number of structural features of the '<em>Leauge</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int LEAUGE_FEATURE_COUNT = 2;

	/**
	 * The number of operations of the '<em>Leauge</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int LEAUGE_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for class '{@link bowling.Leauge <em>Leauge</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Leauge</em>'.
	 * @see bowling.Leauge
	 * @generated
	 */
	EClass getLeauge();
	...
	/**
	 * Returns the meta object for the attribute '{@link bowling.Leauge#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see bowling.Leauge#getName()
	 * @see #getLeauge()
	 * @generated
	 */
	EAttribute getLeauge_Name();

	/**
	 * Returns the meta object for the containment reference list '{@link bowling.Leauge#getPlayers <em>Players</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Players</em>'.
	 * @see bowling.Leauge#getPlayers()
	 * @see #getLeauge()
	 * @generated
	 */
	EReference getLeauge_Players();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link bowling.impl.LeaugeImpl <em>Leauge</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see bowling.impl.LeaugeImpl
		 * @see bowling.impl.BowlingPackageImpl#getLeauge()
		 * @generated
		 */
		EClass LEAUGE = eINSTANCE.getLeauge();
		 ...
		 * @generated
		 */
		EAttribute LEAUGE__NAME = eINSTANCE.getLeauge_Name();
		 ...
		 * @generated
		 */
		EReference LEAUGE__PLAYERS = eINSTANCE.getLeauge_Players();
